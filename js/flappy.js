...
function Passaro(alturaJogo) {
  ...
  this.elemento.src = "pictures/bird.png";
...
function FlappyBird() {
  ...
  this.perdeu = () => {
    ...
    let showPontos = document.querySelector(".pontos");
    let button = document.querySelector(".btn-perdeu");
    perdeu.style.display = "flex";
    showPontos.innerHTML = pontos;
    button.addEventListener("click", () => {
      perdeu.style.display = "none";
      showPontos.innerHTML = 0;
      location.reload(); 
    });
    console.log("chegou");
  };
